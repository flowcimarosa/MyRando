    ...
    <body class="contact loading">
        ...
        <article id="main">
            <header class="special container">
                ...
                <h2>Ajouter les nouvelles étapes</h2>
            </header>
            <!-- One -->
            <section class="wrapper style4 special container small">
                <!-- Content -->
                <div class="content">
                    <form id="ajoutRando" action="inc/ajoutEtape.inc.php" method="POST">
                        <div class="row half no-collapse-1">
                            <div class="12u">
                                <input type="text" name="libelle" placeholder="Libellé de l'étape" />
                            </div>
                        </div>
                        <div class="row half">
                            <div class="12u">
                                <input type="text" name="longitude" placeholder="Longitude de l'étape" />
                            </div>
                        </div>
                        <div class="row half">
                            <div class="12u">
                                <input type="text" name="latitude" placeholder="Latitude de l'étape" />
                            </div>
                        </div>
                        <div class="row half">
                            <div class="6u">
                                <label>Les randonnées :</label>
                                <select name="secteur">
                                    <?php
                                    try {
